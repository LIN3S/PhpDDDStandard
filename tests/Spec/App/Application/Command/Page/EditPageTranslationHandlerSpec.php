 ...
 */
class EditPageTranslationHandlerSpec extends ObjectBehavior
{
    private $pageId;
    private $locale;
    private $title;
    ...
    function let(PageRepository $repository, TemplateFactory $templateFactory, EditPageTranslationCommand $command)
    {
        $this->pageId = 'page-id';
        $this->locale = 'es_ES';
    ...
    function it_cannot_edit_translation_if_the_page_does_not_exist(
        EditPageTranslationCommand $command,
    ...
    function it_edits_a_page_translation(
        EditPageTranslationCommand $command,
        Page $page,
        ...
        $page->addTranslation(Argument::type(PageTranslation::class))->shouldBeCalled();
