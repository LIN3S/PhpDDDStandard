...
use App\Infrastructure\Persistence\Doctrine\DataFixtures\LoadUserData as BaseLoadUserData;
...
class LoadUserData extends BaseLoadUserData implements ContainerAwareInterface
{
    public function setContainer(ContainerInterface $container = null)
    {
        ...
        $this->benGorUserCommandBus = $container->get('bengor_user.user.command_bus');
    }
}
